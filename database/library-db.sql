...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2026 at 02:13 PM
...
CREATE TABLE `books` (
  ...
  `type` enum('sale','borrow','both') NOT NULL DEFAULT 'sale'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'aseel', 'admin@library.com', 'aseel97.4', 'admin', '2026-02-23 11:49:40'),
(2, 'rawan', 'admin2@library.com', 'rawan93.00', 'admin', '2026-02-23 11:50:19'),
(3, 'testuser', 'test@example.com', '$2y$10$cDzb/G5dkbSCTe2wW5/mAOPjHzwIWCXwD.KFw/6OoHisjn88gWzea', 'user', '2026-02-23 13:04:24');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `stock`
  ADD CONSTRAINT `stock_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE;
COMMIT;
