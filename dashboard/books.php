...
<section class="admin-card">
    <div class="toolbar">
        ...
        <a class="btn btn-primary-soft ms-auto" href="/library_project/dashboard/add-book.php"><i class="fa-solid fa-plus"></i> Add Book</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a class="btn btn-secondary-soft" href="/library_project/dashboard/edit-book.php?id=<?php echo (int) $book['id']; ?>">Edit</a>
                                <a class="btn btn-danger-soft" href="/library_project/dashboard/books.php?delete=<?php echo (int) $book['id']; ?>" data-confirm="Delete this book permanently?">Delete</a>
                            </div>
                        </td>
                    </tr>
                <?php endwhile; ?>
