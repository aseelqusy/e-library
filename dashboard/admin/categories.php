...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: /library_project/dashboard/admin/categories.php');
    exit();
}
    ...
    <section class="admin-card">
        ...
        <form method="post" class="admin-form-grid">
            ...
            <div class="admin-form-group full d-flex justify-content-end gap-2">
                <?php if ($editCategory): ?>
                    <a class="btn btn-secondary-soft" href="/library_project/dashboard/admin/categories.php">Cancel</a>
                <?php endif; ?>
