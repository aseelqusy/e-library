...
<section class="admin-card mt-3">
    ...
    <div class="quick-actions">
        <a class="quick-action" href="/library_project/dashboard/admin/add-book.php"><i class="fa-solid fa-plus"></i><span>Add Book</span></a>
        <a class="quick-action" href="/library_project/dashboard/admin/books.php"><i class="fa-solid fa-table"></i><span>Manage Books</span></a>
        <a class="quick-action" href="/library_project/dashboard/admin/users.php"><i class="fa-solid fa-user-gear"></i><span>Manage Users</span></a>
        <a class="quick-action" href="/library_project/dashboard/admin/settings.php"><i class="fa-solid fa-sliders"></i><span>Platform Settings</span></a>
    </div>
</section>
